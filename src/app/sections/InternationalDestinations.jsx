...
function InternationalDestinations() {
  ...
  const destinations = [
    { id: 1, name: "Dubai", duration: "3N 2D", price: "₹20,000", image: "/dubai_1.jpeg" },
    { id: 2, name: "Bali", duration: "4N 3D", price: "₹35,000", image: "/bali_1.jpeg" },
    { id: 3, name: "Maldives", duration: "5N 4D", price: "₹25,000", image: "/maldives_1.jpeg" },
    { id: 4, name: "Singapore", duration: "4N 3D", price: "₹18,000", image: "/singapore_1.jpeg" },
    { id: 5, name: "Thailand", duration: "2N 3D", price: "₹12,000", image: "/thailand_1.jpeg" },
    { id: 6, name: "Vietnam", duration: "5N 6D", price: "₹30,000", image: "/vietnam_1.jpeg" },
  ];
  ...
  return (
    <div className="w-full py-10 px-4 mt-1" ref={containerRef}>
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className={`flex flex-nowrap relative mt-14 transition-all duration-1000 ${
