const singapore = {
  title: "Experience Futuristic Singapore",
  description: "A dynamic city where innovation meets tradition. Discover vibrant street food, iconic landmarks like Marina Bay Sands, and lush gardens in the heart of Singapore.",
  heroImage: "/singapore/singapore_hero_bg_1.png",
  packages: [
    {
      slug: "singapore-malaysia-cruise-tour-9-days",
      title: "Singapore & Malaysia with Cruise",
      cardImage: "/singapore/singapore_pkg_card_1.png",
      duration: "8 Nights / 9 Days",
      places: [
        "Singapore City Tour",
        "Gardens by the Bay (Flower Dome & Cloud Forest)",
        "Sentosa Island (Cable Car, Sky Helix, Wings of Time)",
        "Cruise Experience (2 Nights)",
      ...
      hotels: [
        ...
        "Cruise Ship Cabin (Booked Separately)"
      ],
      actualPrice: 68351,
      olderPrice: 70999,
      overview: {
        description: "Explore the best of Singapore and Malaysia in a thrilling 9-day holiday that includes iconic city tours, theme parks, and a relaxing cruise experience. From Sentosa and Universal Studios to Genting Highlands and Sunway Lagoon, this itinerary offers an unforgettable mix of adventure, luxury, and cultural discovery—perfect for families, couples, and explorers alike."
      },
